#!/usr/bin/env python
"""v2 at T=0.3 — 500-doc val run for ensemble diversity.

Identical to v2 (BD_USE_REFINER=0, few-shot, no targeted pass)
but with BD_TEMPERATURE=0.3 to reduce randomness and diversify vs T=1.0.

v2 baseline (T=1.0): KILE 44.61% / LIR 50.89%

Usage:
    DATA_ROOT=data uv run python tools/v2_t03_500.py
"""
...
OUT_PATH = PROJECT_ROOT / "predictions" / "v2_t03_500.json"
...
async def run_batch() -> None:
    ...
    print(f"v2_t03_500 (this):   KILE {kile_ap:.2f}% / LIR {lir_f1:.2f}%")
